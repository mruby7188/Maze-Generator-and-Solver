...
public class TestProvidedGraph extends BaseTest {
    ...
    public Graph<String, SimpleEdge<String>> buildMST() {
        IList<String> vertices = new DoubleLinkedList<>();
        vertices.add("a");
        vertices.add("b");
        vertices.add("c");
    ...
    @Test(timeout=SECOND)
    public void TestMSTReturnsSame() {
        
        Graph<String, SimpleEdge<String>> graph = this.buildMST();
    ...
    @Test(timeout=SECOND)
    public void testUnconnectedVerticesError() {
        Graph<String, SimpleEdge<String>> graph = this.buildDisconnectedGraph();
        try {
            ISet<SimpleEdge<String>> mst = graph.findMinimumSpanningTree();
            fail("Expected NoPathExistsException");
    ...
    @Test(timeout=SECOND)
    public void testDisconnectedGraphShortestPathInsideConnectedComponents() {
        Graph<String, SimpleEdge<String>> graph = this.buildDisconnectedGraph();
